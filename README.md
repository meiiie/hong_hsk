...
| Gia sư AI | Cloudflare Pages Function gọi NVIDIA Nemotron 3 Ultra để giải thích nghĩa, tạo ví dụ, mẹo nhớ và sửa lỗi sau khi người học đã chấm |
...
AI Tutor mặc định dùng `nvidia/nemotron-3-ultra-550b-a55b` qua Cloudflare Pages Function `/api/ai/tutor`. Có thể override bằng Pages secrets `NVIDIA_MODEL` và `NVIDIA_BASE_URL`, nhưng không đưa API key vào frontend hoặc file cấu hình commit.
