...
- Teal/jade primary color works well with the existing `汉` mark.
...
- Do not add dense charts unless they help Hong decide what to study next.
...
- Use off-white surfaces, ink navy text, jade primary actions, and restrained status colors.
